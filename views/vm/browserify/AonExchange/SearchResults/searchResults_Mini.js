(function (app, global) {
    ...
    ns.setupViewModels = function setupViewModels() {
        ...
        $.ajax({
            ...
            success: function (serverPageViewModels) {
                ...
                EXCHANGE.viewModels.SearchResultsViewModel.loadFromJSON(serverPageViewModels.SearchResultsViewModel, serverPageViewModels.PlanLists);
        ...
        setTimeout(function () {
            ...
            switch (currentTab) {
                ...
                case EXCHANGE.enums.TabIdEnum.MEDICAREADVANTAGE:
                    ...
                    EXCHANGE.viewModels.SearchResultsViewModel.tab0.showAll(true);
    ...
    ns.wireupJqueryEvents = function wireupJqueryEvents() {
        ...
        $('#clear-all-filters').live('click', function () {
            ...
            switch (currentTab) {
                case EXCHANGE.enums.TabIdEnum.MEDIGAP:
                    app.functions.setDropdownSelectedOption('#PlanLetterDiv', EXCHANGE.viewModels.NarrowMyResultsViewModel.filterOptionsCurrentTab()()[0].filter_options()[0]);
                    break;
                case EXCHANGE.enums.TabIdEnum.PRESCRIPTIONDRUG:
                    break;
                case EXCHANGE.enums.TabIdEnum.MEDICAREADVANTAGE:
                    app.functions.setDropdownSelectedOption('#NetworkDiv', EXCHANGE.viewModels.NarrowMyResultsViewModel.filterOptionsCurrentTab()()[0].filter_options()[0]);
                    break;
                default:
                    break;
            }
            ...
            app.functions.setDropdownSelectedOption('#sortBy', EXCHANGE.viewModels.NarrowMyResultsViewModel.sortBySortOptions_lbl());
    ...
    ns.ChangeTargetDt = function ChangeTargetDt(planid) {
        ...
        app.cart.CartAPI.addPlanToCart(planid.InEligiblePlan().planGuid, true, true, function () {
