(function (app, global) {
    ...
    ns.NarrowMyResultsViewModel = function NarrowMyResultsViewModel() {
        if (!(this instanceof NarrowMyResultsViewModel)) {
            return new NarrowMyResultsViewModel();
        }
        var self = this;
        ...
        self.filterOptionsCurrentTab = ko.computed({
            read: function () {
                var filters = self.filterOptionsLists(), currentTab = app.viewModels.SearchResultsViewModel.currentTabIndex();
        ...
        self.sortByOptionsCurrentTab = ko.computed({
            read: function () {
                var options = self.sortByOptionsLists(), currentTab = app.viewModels.SearchResultsViewModel.currentTabIndex();
        ...
        self.sortByOptionsValuesCurrentTab = ko.computed({
            read: function () {
                var values = self.sortByOptionsValuesLists(), currentTab = app.viewModels.SearchResultsViewModel.currentTabIndex();
        ...
        self.sortByTbCurrentTab = ko.computed({
            read: function () {
                var tbs = self.sortByTbLists(), currentTab = app.viewModels.SearchResultsViewModel.currentTabIndex();
        ...
        NarrowMyResultsViewModel.prototype.updateFromSearchState = function updateFromSearchState(searchState) {
        ...
        NarrowMyResultsViewModel.prototype.loadFromJSON = function loadFromJSON(narrowResults) {
            var protoSelf = this;
        ...
        NarrowMyResultsViewModel.prototype.fixFilterLabels = function fixFilterLabels() {
            var protoSelf = this;
        ...
        NarrowMyResultsViewModel.prototype.fixSortLabels = function fixSortLabls() {
            var protoSelf = this;
        ...
        NarrowMyResultsViewModel.prototype.clearFilterRules = function clearFilterRules(engine) {
            var protoSelf = this;
            for (var i = 0; i < protoSelf.filterOptionsCurrentTab()().length; i++) {
        ...
        NarrowMyResultsViewModel.prototype.getResultingFilters = function getResultingFilters() {
            var protoSelf = this;
        ...
        NarrowMyResultsViewModel.prototype.getResultingFiltersByTab = function getResultingFiltersByTab(tab) {
            var protoSelf = this;
        ...
        NarrowMyResultsViewModel.prototype.getResultingSorts = function getResultingSorts() {
            var protoSelf = this;
