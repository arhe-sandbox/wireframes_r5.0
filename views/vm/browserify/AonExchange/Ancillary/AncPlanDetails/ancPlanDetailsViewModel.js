(function (app) {
    ...
    ns.AncPlanDetailsViewModel = function AncPlanDetailsViewModel() {
        if (!(this instanceof AncPlanDetailsViewModel)) {
            return new AncPlanDetailsViewModel();
        }
        var self = this;
        ...
        self.shouldShowDrugTeaser = ko.computed({
            read: function () {
                var show = true;
                if (self.plan.tceLoaded() && self.plan.haveTceData() && app.viewModels.AncPlanDetailsViewModel.medicationsInCabinet()) {
                    show = false;
                }
                else if (self.plan.tceLoading()) {
                    show = false;
        ...
        AncPlanDetailsViewModel.prototype.shouldShowAttributeRow = function shouldShowAttributeRow(AttributeValues) {
        ...
        AncPlanDetailsViewModel.prototype.shouldShowAttributeGroup = function shouldShowAttributeGroup(AttributeGroup) {
        ...
        AncPlanDetailsViewModel.prototype.loadPlanDetails = function loadFromPlanId(planGuid, planDetails) {
            var protoself = this;
            if (planGuid) {
        ...
        AncPlanDetailsViewModel.prototype.isPreferredPharmacy = function isPreferredPharmacy(pharmacyId) {
            var self = this;
        ...
        AncPlanDetailsViewModel.prototype.loadFromPlanViewModel = function loadFromPlanViewModel(planViewModel, planDetails) {
            var protoself = this;
        ...
        function loadPlanDetails(protoself, planDetails) {
            ...
            protoself.planOverviewHeader_lbl = planDetails.AncPlanOverviewHeader_Lbl;
