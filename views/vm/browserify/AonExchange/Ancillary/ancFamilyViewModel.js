(function (app) {
    ...
    ns.ancFamilyViewModel = function ancFamilyViewModel() {
        if (!(this instanceof ancFamilyViewModel)) {
            return new ancFamilyViewModel();
        }
        var self = this;
        ...
        ancFamilyViewModel.prototype.loadFromJSON = function loadFromJSON(viewModel) {
            var protoself = this;
            ...
            protoself.continueBtn_Lbl(viewModel.ContinueBtn_Lbl);            
