(function (app) {
    ...
    ns.MyAccountSidebarViewModel = function MyAccountSidebarViewModel() {
        if (!(this instanceof MyAccountSidebarViewModel)) {
            return new MyAccountSidebarViewModel();
        }
        var self = this;
        ...
        self.ChangingCoverage_Lbl = ko.observable('');
        self.ChangingCoverageText_Lbl = ko.observable('');


        MyAccountSidebarViewModel.prototype.loadFromJSON = function loadfromJSON(viewModel) {
            var protoSelf = this;
            ...
            if (EXCHANGE.viewModels.MyAccountSidebarViewModel.numberOfNewAppointments() == undefined) {
                protoSelf.numberOfNewAppointments(viewModel.numberOfNewAppointments);
            }
            else {
                protoSelf.numberOfNewAppointments(EXCHANGE.viewModels.MyAccountSidebarViewModel.numberOfNewAppointments());
            }
            ...
            protoSelf.ChangingCoverage_Lbl(viewModel.ChangingCoverage_Lbl);
            protoSelf.ChangingCoverageText_Lbl(viewModel.ChangingCoverageText_Lbl);
