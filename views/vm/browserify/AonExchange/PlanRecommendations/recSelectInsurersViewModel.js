(function (app, global) {
    ...
    ns.RecSelectInsurersViewModel = function RecSelectInsurersViewModel() {
        if (!(this instanceof RecSelectInsurersViewModel)) {
            return new RecSelectInsurersViewModel();
        }
        var self = this;

        self.leftTitle_lbl = ko.observable('Select Carrier Preference');
        ...
        self.allInsurersCurrentTab = ko.computed({
            read: function () {
                var insurers = self.allInsurersLists(), currentTab = app.viewModels.RecResultsViewModel.currentTabIndex();
        ...
        self.activeInsurersCurrentTab = ko.computed({
            read: function () {
                var insurers = self.activeInsurersLists(), currentTab = app.viewModels.RecResultsViewModel.currentTabIndex();
                if (insurers.length <= currentTab) {
                    return [];
                }
                return insurers[currentTab];
            ...
            write: function (list) {
                self.activeInsurersLists()[app.viewModels.RecResultsViewModel.currentTabIndex()](list);
            },
            owner: this
        });
        ...
        self.savedInsurersCurrentTab = ko.computed({
            read: function () {
                var insurers = self.savedInsurersLists(), currentTab = app.viewModels.RecResultsViewModel.currentTabIndex();
                if (insurers.length <= currentTab) {
                    return [];
                }
                return insurers[currentTab];
            ...
            write: function (list) {
                self.savedInsurersLists()[app.viewModels.RecResultsViewModel.currentTabIndex()](list);
            },
            owner: this
        });
        ...
        RecSelectInsurersViewModel.prototype.saveCurrentInsurers = function saveCurrentInsurers() {
            var protoSelf = this;
        ...
        RecSelectInsurersViewModel.prototype.resetActiveInsurers = function resetActiveInsurers() {
            var protoSelf = this;
        ...
        RecSelectInsurersViewModel.prototype.selectAll_fnc = function () {
            var protoSelf = this;
            var allInsurers = [];
            var oldAll = protoSelf.allInsurersLists()[app.viewModels.RecResultsViewModel.currentTabIndex()]();
        ...
        RecSelectInsurersViewModel.prototype.selectNone_fnc = function () {
            var protoSelf = this;
            protoSelf.activeInsurersCurrentTab([]);
        };

        RecSelectInsurersViewModel.prototype.loadFromJSON = function loadFromJSON(insurerModel) {
            ...
            protoSelf.errorDesc_lbl(insurerModel.ErrorDesc_RecResults);
        ...
        RecSelectInsurersViewModel.prototype.updateFromSearchState = function updateFromSearchState(viewModel) {
            var protoSelf = this, medigapTabIndex = app.enums.TabEnum.MEDIGAP, prescriptionDrugTabIndex = app.enums.TabEnum.PRESCRIPTIONDRUG, medicareAdvantageTabIndex = app.enums.TabEnum.MEDICAREADVANTAGE;
