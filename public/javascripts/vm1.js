...
this.loadFromJSON = function loadFromJSON(){

  var protoself = this;
  protoself.firstName(this.firstName);
  return protoself;
}
...
//var jsonObj =require('./data/HeaderViewModel.json');

//console.log(console.log(jsonObj.key))
